...
private suspend fun startVideoRecordingInternal(
    ...
    return pendingRecord.start(callbackExecutor) { onVideoRecordEvent ->
        ...
        when (onVideoRecordEvent) {
            //TODO: how to call suspension function here to  update cameraState VideoRecordingState??
            is VideoRecordEvent.Start -> {
                TODO("update to VideoRecordingState.Active.Recording")
            }

            is VideoRecordEvent.Pause -> {
                TODO("update to VideoRecordingState.Active.Paused")
            ...
            is VideoRecordEvent.Finalize -> {
                ...
                TODO("update to VideoRecordingState.Active.Inactive")
            }
...
internal suspend fun processVideoControlEvents(
    ...
    for (event in videoCaptureControlEvents) {
        when (event) {
            ...
            is VideoCaptureControlEvent.PauseRecordingEvent -> {
                TODO("Pause Video not Implemented")
            }
            is VideoCaptureControlEvent.ResumeRecordingEvent -> {
                TODO("Resume Video not Implemented")
            }
