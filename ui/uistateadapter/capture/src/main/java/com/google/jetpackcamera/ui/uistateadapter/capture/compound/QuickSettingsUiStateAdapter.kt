 ...
 * @param trackedCaptureUiState The UI state for the all the quick settings.
...
fun QuickSettingsUiState.Companion.from(
    ...
    return QuickSettingsUiState.Available(
        ...
        flashModeUiState = flashModeUiState,
        flipLensUiState = flipLensUiState,
        gridType = trackedCaptureUiState.gridType,
        hdrUiState = hdrUiState,
        streamConfigUiState = streamConfigUiState,
        quickSettingsIsOpen = trackedCaptureUiState.isQuickSettingsOpen,
        focusedQuickSetting = trackedCaptureUiState.focusedQuickSetting
    )
}
